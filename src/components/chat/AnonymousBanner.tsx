...
export function AnonymousBanner({ remainingMessages, totalMessages }: Props) {
  ...
  return (
    <div className='border-b border-[var(--border-default)] bg-[var(--bg-secondary)] px-4 py-3 sm:px-6'>
      <div
      ...
      >
        ...
        <div className='flex gap-3'>
          <Link
            href='/'
            className='inline-flex items-center justify-center rounded-lg bg-[var(--text-primary)] px-4 py-2.5 text-sm font-medium text-[var(--bg-primary)] transition hover:bg-[var(--accent-hover)]'
          >
